...
function calculartotal() {
    ...
    total = (parseFloat(a) * 10) + (parseFloat(b) *9.90) + (parseFloat(c) * 5) + (parseFloat(d) * 4.90) + (parseFloat(e) * 7.93) + (parseFloat(f) * 4) + (parseFloat(g) * 9.99) + (parseFloat(h) * 3) + (parseFloat(i) * 5.49);
